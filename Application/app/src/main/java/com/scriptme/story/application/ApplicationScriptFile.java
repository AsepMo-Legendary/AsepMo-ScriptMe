...
public class ApplicationScriptFile extends AppCompatActivity {
    
    public static final String TAG = "ApplicationScriptFile";
    public static void start(Context c) {
        Intent mIntent = new Intent(c, ApplicationScriptFile.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mToolbar != null) {     
            ...
            mToolbar.setTitle(getString(R.string.engine_app_script_file));
