...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        int defaultErrorColor = context.getResources().getColor(R.color.engine_color_error);
        ...
        disabledColor = context.getResources().getColor(R.color.engine_color_disabled);
    ...
    private void initPaintObjects() {
        ...
        int labelTextSize = getResources().getDimensionPixelSize(R.dimen.engine_sp_12);
    ...
    private void initDimensions() {
        underlineTopSpacing = getResources().getDimensionPixelSize(R.dimen.engine_dp_8);
        underlineBottomSpacing = getResources().getDimensionPixelSize(R.dimen.engine_dp_4);
        floatingLabelTopSpacing = getResources().getDimensionPixelSize(R.dimen.engine_dp_4);
        floatingLabelBottomSpacing = getResources().getDimensionPixelSize(R.dimen.engine_dp_8);
        rightLeftSpinnerPadding = alignLabels ? getResources().getDimensionPixelSize(R.dimen.engine_dp_8) : 0;
        floatingLabelInsideSpacing = getResources().getDimensionPixelSize(R.dimen.engine_dp_12);
        errorLabelSpacing = (int) getResources().getDimension(R.dimen.engine_dp_12);
        minContentHeight = (int) getResources().getDimension(R.dimen.engine_dp_20);
    }
