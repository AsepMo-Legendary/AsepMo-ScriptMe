...
public class ApplicationEbook extends AppCompatActivity {
    
    public static final String TAG = "ApplicationEbook";
    public static void start(Context c) {
        Intent mIntent = new Intent(c, ApplicationEbook.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mToolbar != null) {     
            ...
            mToolbar.setTitle(getString(R.string.engine_app_ebook));
