...
public class ApplicationTerminal extends AppCompatActivity {
    
    public static final String TAG = "ApplicationTerminal";
    public static void start(Context c) {
        Intent mIntent = new Intent(c, ApplicationTerminal.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mToolbar != null) {     
            ...
            mToolbar.setTitle(getString(R.string.engine_app_terminal));
