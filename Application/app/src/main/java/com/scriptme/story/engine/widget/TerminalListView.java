...
import com.scriptme.story.engine.widget.helper.Scrollable;
import com.scriptme.story.engine.widget.helper.ScrollState;
/**
 * ListView that its scroll position can be observed.
 */
public class TerminalListView extends ListView implements Scrollable {
    ...
    private OnListScrollListener mCallbacks;
    ...
    public TerminalListView(Context context, AttributeSet attrs, int defStyle) {
