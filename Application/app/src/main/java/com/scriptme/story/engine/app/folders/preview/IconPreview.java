...
public class IconPreview {
    ...
    private static final Map<ImageView, String> imageViews = Collections.synchronizedMap(new ConcurrentHashMap<ImageView, String>());
    ...
    public IconPreview(Activity activity) {
        mContext = activity;
        mWidth = (int) mContext.getResources().getDimension(R.dimen.engine_dp_56);
    ...
    private static void loadFromRes(final File file, final ImageView icon) {
        ...
        if (file != null && file.isDirectory()) {
            ...
            final String fileExt = FolderMe.getExtension(file.getName());
        ...
        if (mimeIcon != null) {
            ...
            icon.setColorFilter(theme.getIconColor());
        } else {
            // default icon
    ...
    private static Bitmap getPreview(File file) {
        ...
        if (isImage) {
            ...
            if (packageInfo != null) {
                ...
                mBitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.ic_file_cad);
            }
