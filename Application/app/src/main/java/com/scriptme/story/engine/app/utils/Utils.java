...
public class Utils {
     ...
     */
    public native static FileDescriptor createSubProcess(String cwd, String cmd, String[] args, String[] envVars, int[] processId);

    public native static void setPtyWindowSize(FileDescriptor fd, int row, int col, int xpixel, int ypixel);
