...
public class MimeTypes {
     ...
     */
    public boolean isTextFile(BaseFile file) {
     ...
     */
    public boolean isImageFile(BaseFile file) {
     ...
     */
    public boolean isAPKFile(BaseFile file) {
    ...
    public boolean isArchive(BaseFile file) {
     ...
     */
    public boolean isVideoFile(BaseFile file) {
    ...
    public boolean isAudioFile(BaseFile file) {
...
//mp3|wma|wav|aac|ogg|m4a|flac
    ...
    public boolean isCodeFile(BaseFile file) {
