...
public abstract class BaseFile implements Parcelable {
     ...
     *          If <code>child</code> is <code>null</code>
     */
    public BaseFile(BaseFile parent, String child) {
        if (child == null) {
            throw new NullPointerException();
        }
    }
     ...
     * @return
     */
    public abstract BaseFile newFile(String filename);
     ...
     * @since 1.2
     */
    public abstract BaseFile getParentFile();
     ...
     * @since 1.2
     */
    public abstract BaseFile getAbsoluteFile();
     ...
     */
    public abstract void renameTo(BaseFile dest, BoolResultListener listener);

    public abstract void copyTo(BaseFile dest, BoolResultListener listener);
