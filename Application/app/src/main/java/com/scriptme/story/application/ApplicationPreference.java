...
public class ApplicationPreference extends AppCompatActivity {
    
    public static final String TAG = "ApplicationPreference";
    public static void start(Context c) {
        Intent mIntent = new Intent(c, ApplicationPreference.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mToolbar != null) {     
            ...
            mToolbar.setTitle(getString(R.string.engine_settings));
